						...
						<permission:path roles="superadmin">
							<li class="dropdown" id="customer_li">
								...
								<ul class='dropdown-menu head-menu'>
									...
									<li id="user_li"><a href="<webpath:path/>/calculationscript/list"> <i
											class="icon-double-angle-right"></i> Script
									</a></li>
								</ul>
							</li>
						</permission:path>
						...
						<li class="dropdown" id="employee_schedules_li">
							...
							<ul class='dropdown-menu head-menu'>
								...
								<li class='' id="recalculate_li" draggable="true"><a
									href='<webpath:path/>/recalculate/condition'> <i class='icon-rotate-right'></i> <span>Recalculate
											Schedule</span>
								</a></li>
						...
						<li class="dropdown " id="common_functions_li">
							...
							<ul class='dropdown-menu head-menu'>
								...
								<li class='' id="script_config_li" draggable="true"><a
									href='<webpath:path/>/payrolltransfer/employees'> <i class=' icon-money '></i> <span>Payroll Transfer</span>
								</a></li>
								<li><a href="<webpath:path/>/report/view"> <i class="icon-bar-chart "></i>
										Generate Reports
								</a></li>

								<li><a href="<webpath:path/>/sendreport/list"> <i class="icon-bar-chart "></i> Auto
										Send Reports
								</a></li>
