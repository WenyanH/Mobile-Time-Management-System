	           ...
	           <div class='row-fluid'>
	           		<div class="span12">
	           			<div class="control-group">
							...
							<div class="controls">
								<select  class="span12" id="scheduleId" name="scheduleId" data-placeholder=" " tabindex="3" >
									<option value=""></option>
								</select>
							</div>
						</div>
	           ...
	           <div class='row-fluid'>
	           		<div class="span12">
	           			<div class="control-group">
							...
							<div class="controls">
								<select  class="span12" id="timeRoundingId" name="timeRoundingId" data-placeholder=" " tabindex="5" >
									<option value=""></option>
