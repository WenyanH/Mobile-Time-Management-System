...
(function($) {
    ...
    for (var i = 0; i < 60; i++) {
        var j = (i < 10)? "0":"";
        str_opt_mih += "<option value='"+i+"'>" + j +  i + MINUTE+"</option>\n";
    }
    ...
    for (var i = 0; i < 24; i++) {
        var j = (i < 10)? "0":"";
        str_opt_hid += "<option value='"+i+"'>" + j + i + HOUR_+"</option>\n";
    }
    ...
    for (var i = 1; i < 32; i++) {
        ...
        str_opt_dom += "<option value='"+i+"'>" + i + suffix + DATE + "</option>\n";
    }
    ...
    var i18 = {"minute":MINUTE,"hour": HOUR,"day" : DAY,"week": WEEK,"month": MONTH,"year": YEAR};
    for (var i = 0; i < periods.length; i++) {
        str_opt_period += "<option value='"+periods[i]+"'>" + i18[periods[i]] + "</option>\n";
    }
