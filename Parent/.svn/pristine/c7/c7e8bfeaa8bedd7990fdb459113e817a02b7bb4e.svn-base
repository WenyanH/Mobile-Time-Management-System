...
<input class="span12" name="reportType" type="hidden"  value="ExceptionsReport" />
				...
				<div class="portlet-body">
					<div class="row-fluid">
						...
						<div class="span6">
							...
							<div class="control-group">
									<label class="control-label"> <span>Exception Types</span></label>
									<div class="controls">
									<select id="diffPeriod" name="type" multiple="multiple" class="" >
											<option value=""> </option>
