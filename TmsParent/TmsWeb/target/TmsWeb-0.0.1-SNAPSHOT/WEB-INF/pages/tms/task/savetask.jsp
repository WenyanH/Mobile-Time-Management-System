			    ...
			    <div class="control-group">
					...
					<div class="controls">
						<div class='row-fluid'>
						    ...
						    <c:if test="${task.id==null}">	
						    <input class="span6" name="punchCode" type="text" id="punchCode" value="${task.punchCode}"  maxlength="10" disabled/>
						    </c:if>
					        <c:if test="${task.id!=null}">    
						    <input class="span6" name="punchCode" type="text" id="punchCode" value="${task.punchCode}" maxlength="10"
