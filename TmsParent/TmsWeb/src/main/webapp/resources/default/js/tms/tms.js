(function() {
    $(document).ready(function() {
        ...
        $('body').on('click', '#menuContent_global', function(e){
            e.stopPropagation();
        })
        ...
        $("#daterange2").daterangepicker({
	        ...
	        ranges: {
	        	'6小时': [moment().subtract('hours', 6), moment()],
	            '一天':  [moment().subtract('days', 1), moment()],
	            '一周':  [moment().subtract('days', 6), moment()],
	            '一月':  [moment().subtract('days', 29), moment()],
	            
	         },
	         opens: 'left'
        }, function(start, end) {
        	
            return $("#daterange2").parent().find("input").first().val(start.format("YYYY-MM-DD HH:ss") + " -- " + end.format("YYYY-MM-DD HH:ss"));
        });
