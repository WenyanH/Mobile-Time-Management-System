	...
	<div class='span12'>
		<div class='page-header'>
			<div class='pull-left title'>
				...
				<fmt:message key="saveemployee.info.createemployee" /><!--Create Employees-->
				</c:if>
				</span>			
			</div>
						...
						<div class='row-fluid' style="min-height:227px;" >
							...
							<div class="span4">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input class="span12" name="password" id="password" type="password" value=""/>
									</div>
								</div>
