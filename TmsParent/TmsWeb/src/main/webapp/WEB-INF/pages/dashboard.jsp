	...
	<div class='span12'>
		<div class='page-header'>
			<div class='pull-left title'>
				<span><fmt:message key="global.info.dashboard" /><!--Dashborad--></span>
			</div>
				...
				<div class="row-fluid">
					<div style="margin-bottom: 0;"
						...
						<div class="box-content box-no-padding">
							    	...
							    	<img src="<webpath:path/>/resources/default/images/user.png" class="" style="width: 60px;"/>
							    	</c:if>
							    	
							    	<c:if test="${user.photo!=null&&user.photo!=''}">
							    	<img src="data:image/png;base64,${user.photo}" style="width: 60px;" class=""/>
							    	</c:if></td>
