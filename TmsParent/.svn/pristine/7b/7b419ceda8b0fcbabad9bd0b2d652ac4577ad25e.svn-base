...
<div class='row-fluid'>
	<div class='span12'>
		<div class='page-header'>
			...
			<span><fmt:message key="paygrouplist.info.paygroup" /><!--Pay Groups--></span>
			</div>
			
			<div class="pull-right"> 	
	            	<button id="inplaceediting-enable" class="btn btn-success" onclick="paygroup.create();"><i class="icon-plus "></i> <span><fmt:message key="global.info.new" /><!--New--></span></button>
					<button id="inplaceediting-enable" class="btn btn-danger" onclick="paygroup.remove();"><i class="icon-trash"></i> <span><fmt:message key="global.info.delete" /><!--Delete--></span></button>
			</div>
		</div>
	</div>
</div>

<div id="paygroup-table">
	<div class="row-fluid">
...
<script src="<webpath:path/>/resources/default/js/tms/tmssetting/paygroup.js" type="text/javascript"></script>
