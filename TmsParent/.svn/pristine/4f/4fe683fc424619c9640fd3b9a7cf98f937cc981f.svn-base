...
<form id="employeeForm" action='#' onsubmit="return false;"
	class="form form-horizontal " style="margin-bottom: 0;" method="post"
	...
	<div class="row-fluid" id="savebutton" onclick="saveEmployeeStatus();">
...
function saveEmployeeStatus(){
	...
	PageCtrl.ajax({
		url : webPath + "/employee/saveStatus",
